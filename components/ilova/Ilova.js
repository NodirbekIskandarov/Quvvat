            ...
            <div className="ilovaSon">
                ...
                <div className="ilovaUse">
                    <div className="ilovaUseSon">
                        <h2 className="second">Barcha stansiyalar ONLAYN</h2>
                        <p>Barcha TOKBOR stansiyalari doimo serverga ulangan. Ilovamizdan foydalanib, foydalanuvchilar darhol quvvat berish stansiyalari va ularning yuklanishi haqida maʼlumot oladilar.</p>
                        <button><a href="">QUVVAT BERISH STANSIYALARI</a></button>
                    </div>
                </div>
            </div>
        </div>
